# slackbot2 <img src="https://asobi-works.com/wp-content/uploads/2017/02/hubot.jpg" width="300" align="right">
...
hubot news `<query>` | Search the latest HK News of the `<query>`
